    ...
    return (
        ...
        <div className={RulesCSS.rulesContainer}>
            ...
            <div className={RulesCSS.rulesgridcontainer}>
                ...
                <div className="griditem"><img src={require('../rules-images/img1.gif')} alt="gif"/> </div>
                <div className="griditem"><img src={require('../rules-images/img2.gif')} alt="gif"/></div>
                ...
                <div className="griditem"><img src={require('../rules-images/winner.gif')} alt="gif"/></div>
            </div>
